...
directory_data_train= 'train' #Указываем путь к обучающей выборке train_data_dir
directory_data_validation= 'validation'  #Указываем путь к проверочной выборке validation_data_dir

# Сразу устанавливаем необходимые параметры

train_sample = 780
validation_sample = 162
epochs = 14
lot_size = 7  #batch_size
...
# pattern.save_weights('model_weights.h5') #Сохранение весов модели
# pattern.save('my_model.h5') #Сохранение модели